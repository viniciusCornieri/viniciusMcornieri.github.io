...
//push notification code below
self.addEventListener('push', function(event) {
  console.log('[Service Worker] Push Received.');
  console.log(`[Service Worker] Push had this data: "${event.data.text()}"`);

  const title = 'The rain is coming!';
  const options = {
    body: event.data.text(),
    icon: '/weather-pwa/images/rain.png',
    badge: '/weather-pwa/images/rain.png'
  };
...
self.addEventListener('notificationclick', function(event) {
  ...
  event.waitUntil(
    clients.openWindow('https://media.giphy.com/media/S6C6G3pW8vRh6/giphy.gif')
  );
});
